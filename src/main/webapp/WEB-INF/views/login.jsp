                        ...
                        <div class="card-body">
                            <div id="formData" class="needs-validation" novalidate="">
                                <div class="form-group">
                                    ...
                                    <input id="userId" type="text" class="form-control" name="userId" tabindex="1"
                                           placeholder="아이디"
                                           required autofocus>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="remember" class="custom-control-input" tabindex="3"
                                               id="moveList">
                                        <label class="custom-control-label" for="moveList">쿠폰 내역으로 바로 이동하기</label>
                                    </div>
                                </div>
    ...
    function login() {
        ...
        $.ajax({
            ...
            success: function (cmd) {
                if (cmd.code == '0000') {
                    $('#moveList').is(":checked") == true ?
                        window.location.assign("/coupon/issuance") :
