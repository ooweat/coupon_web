                    ...
                    <div class="card card-primary custom-card">
                        <div class="card-body">
                            <div class="row form-divider text-primary">
                                그룹 고객사 관리
                                <a class="btn btn-primary" href="#" onclick="insertGroup()">신규등록
                                    <span
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-1 col-xl-2 col-md-2 mb-1 p-0">
                                        <div class="col-lg-12 col-md-12 text-center p-0 w-100 h-100">
                                            <button type="button" onclick="validationCheck3('1');"
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-md fancy-table">
                                    ...
                                    <c:choose>
                                        <c:when test="${searchCount>0}">
                                            <c:forEach var="groupList" items="${searchList}">
                                                <tr onclick="location.href='/group/clientInfo?paramGroupSeq=${groupList.groupSeq}'">
                                                    ...
                                                    <td class="text-center"
                                                        onclick="postParams('/group/clientInfo',
                                                                params={paramGroupSeq : '${groupList.groupSeq}', paramGroupName : '${groupList.groupName}'});">
                                                        <a href="#"
                                                           class="btn btn-primary"><span>관리</span></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </c:when>
                                        <c:otherwise>
                                            <tr>
                                                <td>결과 값을 찾을 수 없습니다. Not Found Err</td>
                                            </tr>
                                        </c:otherwise>
                                    </c:choose>
                                    </tbody>
